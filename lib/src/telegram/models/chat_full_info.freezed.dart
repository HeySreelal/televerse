...
class _$ChatFullInfoCopyWithImpl<$Res> implements $ChatFullInfoCopyWith<$Res> {
      ...
      _self.copyWith(
        ...
        uniqueGiftColors: freezed == uniqueGiftColors
            ...
            : uniqueGiftColors // ignore: cast_nullable_to_non_nullable
                  as UniqueGiftColors?,
        firstProfileAudio: freezed == firstProfileAudio
  ...
  @pragma('vm:prefer-inline')
  $ChatCopyWith<$Res>? get parentChat {
    if (_self.parentChat == null) {
      return null;
    }

    return $ChatCopyWith<$Res>(_self.parentChat!, (value) {
      return _then(_self.copyWith(parentChat: value));
    });
  }
  ...
  @pragma('vm:prefer-inline')
  $AudioCopyWith<$Res>? get firstProfileAudio {
    if (_self.firstProfileAudio == null) {
      return null;
    }
