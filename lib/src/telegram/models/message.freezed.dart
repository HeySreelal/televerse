...
class _Message implements Message {
  const _Message({
    ...
    @JsonKey(name: 'sender_tag') this.senderTag,
    @JsonKey(name: 'managed_bot_created') this.managedBotCreated,
    @JsonKey(name: 'guest_bot_caller_user') this.guestBotCallerUser,
    @JsonKey(name: 'guest_bot_caller_chat') this.guestBotCallerChat,
    @JsonKey(name: 'guest_query_id') this.guestQueryId,
    @JsonKey(name: 'live_photo') this.livePhoto,
    @JsonKey(name: 'rich_message') this.richMessage,
    @JsonKey(name: 'receiver_user') this.receiverUser,
    @JsonKey(name: 'ephemeral_message_id') this.ephemeralMessageId,
    @JsonKey(name: 'community_chat_added') this.communityChatAdded,
    @JsonKey(name: 'community_chat_removed') this.communityChatRemoved,
  }) : _entities = entities,
       _photo = photo,
  ...
  @override
  @JsonKey(name: 'managed_bot_created')
  final ManagedBotCreated? managedBotCreated;

  /// Optional. For a message sent by a guest bot, this is the user whose
  /// original message triggered the bot's response
  @override
  @JsonKey(name: 'guest_bot_caller_user')
  final User? guestBotCallerUser;

  /// Optional. For a message sent by a guest bot, this is the chat whose
  /// original message triggered the bot's response
  @override
  @JsonKey(name: 'guest_bot_caller_chat')
  final Chat? guestBotCallerChat;
  ...
  @override
  @JsonKey(name: 'community_chat_added')
  final CommunityChatAdded? communityChatAdded;

  /// Optional. Service message: chat removed from a Community
  @override
  @JsonKey(name: 'community_chat_removed')
  final CommunityChatRemoved? communityChatRemoved;
